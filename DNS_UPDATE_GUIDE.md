...
3. Navigate to: **Domains** → **pawelgawliczek.cloud** → **DNS / Name Servers**
...
dig vibestudio.pawelgawliczek.cloud +short

# Should return: 72.61.176.212
```

You can also use online tools:
- https://www.whatsmydns.net/#A/vibestudio.pawelgawliczek.cloud
- https://dnschecker.org/#A/vibestudio.pawelgawliczek.cloud
...
3. **Access your application**:
   - Frontend: https://vibestudio.pawelgawliczek.cloud
   - API: https://vibestudio.pawelgawliczek.cloud/api
   - Health: https://vibestudio.pawelgawliczek.cloud/api/health
...
2. Or remove the old `aistudio.pawelgawliczek.cloud` A record
...
curl -X POST "https://api.hostinger.com/dns/v1/domains/pawelgawliczek.cloud/records" \
...
Current working subdomains on pawelgawliczek.cloud:
...
### Still not working?
- Verify DNS: `dig vibestudio.pawelgawliczek.cloud`
- Check Caddy config: `docker exec caddy-caddy-1 caddy validate --config /etc/caddy/Caddyfile`
- Test locally: `curl -H "Host: vibestudio.pawelgawliczek.cloud" http://localhost`
