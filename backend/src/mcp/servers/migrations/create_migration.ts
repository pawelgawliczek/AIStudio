...
export async function handleCreateMigration(
  ...
  try {
    ...
    const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://postgres:361a30c6d68396be29c7eddc3f9ff1b1cfe07675c707232a370bda33f7c8b518@127.0.0.1:5432/vibestudio?schema=public';
