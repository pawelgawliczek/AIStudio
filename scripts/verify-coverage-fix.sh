...
API_BASE="https://vibestudio.pawelgawliczek.cloud/api"
...
test_endpoint() {
    ...
    if [ "$http_status" = "401" ]; then
        ...
        echo "1. Log into https://vibestudio.pawelgawliczek.cloud"
...
if [ $failed -eq 0 ]; then
    ...
    echo "   https://vibestudio.pawelgawliczek.cloud/code-quality/$PROJECT_ID"
    echo ""
