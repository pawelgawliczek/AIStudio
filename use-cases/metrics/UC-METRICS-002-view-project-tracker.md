...
## Main Flow
1. User navigates to "Tracker" tab in web UI (https://studio.pawelgawliczek.cloud/)
...
## UI/UX Requirements
The user mentioned:
> "for the project management part view is also created in https://studio.pawelgawliczek.cloud/ -> Tracker. It already has all required field but i dont like how this is implemented."
